...
\begin{itemize}
  ...
  \item \hliii{þtarhaspa} \emph{willow} → \hliii{þtarhas}\hliv{-þdu-}\hliii{pa} \emph{around the willow}
\end{itemize}
...
\begin{itemize}
  ...
  \item \hliii{þtarhaspa} \emph{willow} → \hliii{þtar}\hliv{-dira-}\hliii{haspa} or \hliii{þtarhas}\hliv{-dira-}\hliii{pa} \emph{around the willow}
\end{itemize}
