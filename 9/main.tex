...
\begin{itemize}
  \item An onset: any consonant other than \ortho{m} /n̼/. At the beginning of the word, this is optional, but any medial syllables with an empty onset will receive an epethentic [ɹ̥] at that position.
  \item A rime – one of:
  \begin{itemize}
