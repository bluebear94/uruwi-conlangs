 HOURS_PER_DAY = 24;
 DAYS_PER_MONTH = 30.80152;
 DAYS_PER_SYEAR = 302.03719;
 DAYS_PER_TYEAR = 301.94714;
 ...
 EMS.T = +360 / (1 + 1 / DAYS_PER_MONTH) / HOURS_PER_DAY;
 EMS.s = +360 / (DAYS_PER_MONTH) / HOURS_PER_DAY;
 EMS.h = +360 / (DAYS_PER_TYEAR) / HOURS_PER_DAY;
 EMS.p = +360 / (DAYS_PER_SYEAR * 10.62) / HOURS_PER_DAY;
 EMS.N = +360 / (DAYS_PER_SYEAR * 25.84) / HOURS_PER_DAY;
 EMS.pp = +360 / (DAYS_PER_SYEAR * 18539) / HOURS_PER_DAY;
