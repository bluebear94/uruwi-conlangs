...
~\\
\textkardinal{\hli{maki\^oha} \hlii{txorom-s\^xin,} \hliii{doran} \hliv{jace} \hlv{nyara} \hlvi{ro} \hlvii{net.}} \\
...
~\\
\textkardinal{\hli{maki\^oha} \hlii{.u\^o-s\^xin} \hliii{txoro,} \hliv{doran} \hlv{jace} \hlvi{nyara} \hlvii{ra} \hlviii{net.}} \\
