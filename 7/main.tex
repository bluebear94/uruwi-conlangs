...
\ifiamascrubandineedaromanisedversion
    \renewcommand{\textkardinal}{\textrm}
    \renewcommand{\kardinal}{\rmfamily}
\fi
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|}
        \hline
        & \textrm{Bilabial} & \textrm{Alveolar} & \textrm{Palatal} & \textrm{Velar} & \textrm{Glottal} \\
        \hline
...
\centering
    ...
    \begin{tabular}{|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|}
        \hline
        \textrm{Spread} & \textrm{Half-rounded} & \textrm{Rounded} \\
        \hline
        i & i\^u & i\^o \\
        u\^i & u & u\^o \\
        e & & e\^o \\
...
\newcommand{\overcol}{& \textrm{Integral} & \textrm{Nullary} & \textrm{Singular} & \textrm{Dual}}
\begin{longtabu}{|r|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|}
    ...
    \hline
    \multicolumn{5}{|l|}{\textrm{Sentient: \hortho{masa} ``person''}} \\
    \hline
    Nominative & masa & masake & masas & masal \\
    Accusative & masan & masan\^gke & masanis & masanal \\
    \hline
    \multicolumn{5}{|l|}{\textrm{Sentient: \hortho{s\^ha.en} ``magician''}} \\
    \hline
...
\newcommand{\overcolm}{& \textrm{Plural} & \textrm{Nullary} & \textrm{Subingular} & \textrm{Supersingular}}
\begin{longtabu}{|r|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|}
    ...
    \hline
    \multicolumn{5}{|p{\linewidth}|}{\textrm{Measure: \hortho{rumu\^i} ``day\^{continuous}''}} \\
    \hline
    Nominative & rumu\^i & rumu\^iru\^o & rumu\^it & rumu\^in \\
    Accusative & rumu\^in & rumu\^iru\^on & rumu\^into\^e & rumu\^inu\^in \\
    \hline
    \multicolumn{5}{|l|}{\textrm{Measure: \hortho{mel} ``volume'' (in expressions such as \hortho{mel-yuso\^e} ``cupful'')}} \\
    \hline
...
\begin{longtabu}{|r|>{\kardinal}l|}
    ...
    \hline
    \multicolumn{2}{|p{\linewidth}|}{\textrm{Fluid: \hortho{f\^xuru\^o} ``water''}} \\
    \hline
    Nominative & f\^uru\^o \\
    Accusative & f\^uru\^on \\
    \hline
    \multicolumn{2}{|l|}{\textrm{Fluid: \hortho{dekem} ``nitrogen''}} \\
    \hline
    Nominative & dekem \\
    Accusative & dekemin \\
    \hline
    ...
    \hline
    \multicolumn{2}{|p{\linewidth}|}{\textrm{Edible: \hortho{ter.i\^o} ``beef''}} \\
    \hline
    Nominative & ter.i\^o \\
    Accusative & ter.i\^on \\
    \hline
    \multicolumn{2}{|p{\linewidth}|}{\textrm{Edible: \hortho{man} ``rice''}} \\
    \hline
    Nominative & man \\
    Accusative & manin \\
    \hline
    \multicolumn{2}{|p{\linewidth}|}{\textrm{Inedible: \hortho{ru\^oto} ``gold''}} \\
    \hline
    Nominative & ru\^oto \\
    Accusative & ru\^otobe \\
    \hline
    \multicolumn{2}{|p{\linewidth}|}{\textrm{Inedible: \hortho{kacas} ``stone''}} \\
    \hline
    Nominative & kacas \\
    Accusative & kacaspe \\
    \hline
    \multicolumn{2}{|p{\linewidth}|}{\textrm{Abstract: \hortho{f\^hu\^omo} ``empathy''}} \\
    \hline
    Nominative & f\^hu\^omo \\
    Accusative & f\^hu\^omon\^g \\
    \hline
    \multicolumn{2}{|p{\linewidth}|}{\textrm{Abstract: \hortho{gis} ``[the number] five''}} \\
    \hline
    Nominative & gis \\
    Accusative & gisin\^g \\
\end{longtabu}
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|}
        \hline
        (continuous) & \textrm{Pl. / Sub. / Sup.} & \textrm{Nullary} & \invalid & \invalid \\
        (discrete) & \textrm{Integral} & \textrm{Nullary} & \textrm{Singular} & \textrm{Dual} \\
        \hline
...
``X's Y'' is translated as \hortho{\textrm{Y=}ma sil \textrm{X}}. The possessive construction is also used to create appositives.
...
\begin{table}[h]
    \centering
    \caption{Polarity-tellicity suffixes for verbs.}
    \label{table:conjpoltell}
    \begin{tabular}{|l|>{\kardinal}l|>{\kardinal}l|>{\kardinal}l|}
        \hline
        & \textrm{Positive} & \textrm{Negative} & \textrm{Interrogative} \\
        \hline
        Telic & -∅ & -ke / -ko\^e & -ha \\
...
\begin{longtabu} to \linewidth {|l|>{\kardinal}l|X|}
    ...
    \hline
    Aspect name & \textrm{Marking} & Meaning \\
    \endfirsthead
...
\hli{and-\tsc{other.past}} \hlii{Ri\^use} \hliii{Tarul,} \hliv{eat-\tsc{anaph\_sub.past}} \hlv{beef-\tsc{acc}} \\
\hlii{Ri\^use} \hli{and} \hliii{Tarul} \hliv{ate} \hlv{beef.} \\
...
\hli{and-\tsc{other.past}} \hlii{Ri\^use} \hliii{Tarul,} \hliv{and-\tsc{other.past}} \hlv{beef} \hlvi{soup,} \hlvii{eat-\tsc{other.past}} \hlviii{\tsc{def}\tl{}person-\tsc{du}} \hlix{\tsc{pr.anaph\_sub.cont}} \\
\hlviii{[They,]} \hlii{Ri\^use} \hli{and} \hliii{Tarul} \hlvii{ate} \hlv{beef} \hliv{and} \hlvi{soup.}
...
\begin{longtable}[c]{|r|>{\kardinal}r|>{\kardinal}l|}
    ...
    \hline
    base 10 & \textrm{base v} & \textrm{word} \\
    \hline
    \endfirsthead
...
\begin{longtable}[c]{|>{\kardinal}r|r|r|}
    ...
    \hline
    \textrm{``Multiple''} & Difference from last & Total \\
    \hline
    \endfirsthead
