...
Semantically, descriptors act like expression trees that are covered by their antecedents. For instance, if \hliii{Weather} was modified by a descriptor acting like \hliii{Sun}, then the resulting tree would be \hliii{Weather}(\hliii{Sun}).
