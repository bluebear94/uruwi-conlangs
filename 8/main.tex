...
The morpheme \hortho{m} \emph{=} joins the two nodes around it and returns a single node that equates its arguments and refers to the entity in question. \\
~\\
...
It is natural that coördinating compounds can involve any number of constituents
