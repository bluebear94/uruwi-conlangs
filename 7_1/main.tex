...
\begin{longtabu}{|r|>{\kardinal}Y|>{\kardinal}Y|}
    ...
    Accusative & .ime\hliii{zim} (.imezim) & .imeri\hliii{fi} (.imerifi) \\
\end{longtabu}
...
\sloppy{
  ...
  \textkardinal{\hli{prin} \hlii{ni} \hliii{k\^xrik\^xriden,} \hliv{senan} \hlv{ta} \hlvi{bes.}} \\
  ...
  \textkardinal{\hli{prink\^xa} \hlii{ni} \hliii{k\^xrik\^xriden,} \hliv{senan} \hlv{ta} \hlvi{bes.}} \\
...
An example: \\
~\\
\textkardinal{\hli{t\^xalaktmi1} \hlii{ta} \hliii{ni,} \hliv{xini.el6} \hlv{pqn\^gafu-ra.}} \\
\textkardinal{\hli{t\^xalkatmi1} \hlii{ta} \hliii{ni,} \hliv{xini.el6} \hlv{pqn\^gafu-ra.}} \\
