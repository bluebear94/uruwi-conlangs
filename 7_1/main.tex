...
The anaphoric pronoun \hortho{bes} (accusative: \hortho{bezen}) is grammatically an other pronoun, and it refers to the previous clause said. Likewise, \hortho{bpeis} (accusative: \hortho{bpein}) refers to the clause before the previous one.
