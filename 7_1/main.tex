...
\begin{figure}
    \caption{ASTs for the clauses at the deepest nesting level. \label{fig:clauseast1}}
    \centering
    \begin{tikzpicture}
        ...
        \begin{scope}[yshift=-9cm,xshift=2cm]
            \Tree [.S
                [.V return [.\tsc{past-q} ] ]
                [.N \tsc{pr.anaph\_sub} ]
                [.N [.role\footnote{We use \hortho{skofl}, which has a connotation of normalcy, so we need not explicitly state that it is ``proper''.} [.GEN [.slavery lifelong ] ] ] ]
            ]
        \end{scope}
