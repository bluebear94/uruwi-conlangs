...
Ḋraħýl Rase is written in \emph{Nasél Tēkel Piva} (\emph{lit.} New Sun Glyphs), a native script that uses dedicated glyphs for consonants and long vowels, plus diacritics for short vowels. It does not mark pitch accent.
