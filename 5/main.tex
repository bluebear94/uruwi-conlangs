...
Aspect affixes are ordered such that the leftmost affixes apply before those on the right. Take the contrived example \ortho{tṡageltekṡavoḋuħanasitmanetufṡuṫys}, starting before the first aspect affix: \\
~\\
